...
http_server.serve_static_content_from_ram('/', '.')
if service=='nixio' then
	http_server.serve_static_content_from_stream('/images/', './images')
	http_server.serve_static_content_from_stream('/scripts/', '../.tmp/scripts')
	http_server.serve_static_content_from_stream('/styles/', '../.tmp/styles')
else
	http_server.serve_static_content_from_ram('/images/', './images')
	http_server.serve_static_content_from_ram('/scripts/', '../.tmp/scripts')
	http_server.serve_static_content_from_ram('/styles/', '../.tmp/styles')
end
